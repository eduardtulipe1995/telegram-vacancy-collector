...
- Красивое форматирование сообщений с emoji
...
✍️ 1. Сценарист для YouTube-канала
   🏢 Creative Studio
   🔗 https://t.me/channel/123

🎬 2. Видеоредактор (удаленно)
   🏢 Media Production
   🔗 https://t.me/channel/456

👔 3. Шеф-редактор видеопродакшн
   🏢 VideoLab
...
**Сценарист:**
- Keywords: сценарист, screenwriter, копирайтер-сценарист, автор сценариев, script writer
- Видео-контекст: не требуется

**Редактор (только видео):**
- Keywords: редактор видео, видеоредактор, video editor, монтажер, colorist, режиссер монтажа
- Exclude: редактор текста, литературный редактор, книжный редактор, копирайтер
- Видео-контекст: ОБЯЗАТЕЛЕН (минимум 1 упоминание: видео, монтаж, youtube, premiere и др.)

**Шеф-редактор (только видео):**
- Keywords: шеф-редактор, главный редактор, ведущий редактор, senior editor
- Exclude: книжное издательство, журнал, газета, новостной
- Видео-контекст: ОБЯЗАТЕЛЕН

### Ключевые слова видео-контекста (50+)

видео, монтаж, ролик, youtube, tiktok, reels, premiere, after effects, davinci, анимация, motion graphics, трейлер, vfx, режиссёр, кино, сериал, продакшн, съёмка и другие.
...
Step 5: Filtering vacancies by position...
...
│   ├── vacancy_filter.py       # Filter by position
