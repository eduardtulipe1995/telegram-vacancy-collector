...
class VacancyFilter:
    ...
    TARGET_POSITIONS = {
        ...
        'шеф-редактор': {
            ...
            'exclude': [
                'книжное издательство', 'книжный', 'медиа',
                'журнал', 'газета', 'онлайн-медиа', 'онлайн медиа',
                'издательств', 'журналист'
            ],
